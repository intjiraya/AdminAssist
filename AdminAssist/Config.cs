...
public class Config : IConfig
{
    ...
    public HashSet<string> CommandAliases { get; set; } = new() { "call", "admin" };
    ...
    [Description("A set of permissions that will receive requests from players.\n" +
                 "These permissions should correspond to RA permission levels.")]
    public HashSet<string> Permissions { get; set; } = new() { "CallNotify", "PlayerSensitiveDataAccess" };

    [Description("If true, all players with RA permissions will receive requests.")]
